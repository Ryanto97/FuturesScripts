...
function OnLoad(executionContext) {
   ...
   // RemoveOldComplaints();
    ...
    function OldComplaintsSubject() {
    debugger;
    var oldComplaintsRole = Blacklight.UserHasRoleAssigned("4c522d06-7735-f011-8c4d-00224840e12d"); // Complaints Security Role

    if (!oldComplaintsRole) {
